...
class _MenuDetailScreenState extends State<MenuDetailScreen> {
  late Product _product; // Future<Map<String, dynamic>?>로 수정
  ...
  void _fetchProduct() async {
    ...
    if (productData != null) {
      setState(() {
        _product = Product.fromMap(productData);
        _isLoading = false; // 데이터 로딩 완료 후 상태 변경
      });
    }
  }
        ...
        bottomSheet: SizedBox(
          ...
          child: ElevatedButton(
            onPressed: () {
              ...
              setState(
                () {
                  product.option.itemList = product.option.itemList.map(
                    (item) {
